...
<p>It is <strong>not</strong> necessary to install Pale Moon to use it. It is distributed as an bzipped tarball which can be extracted anywhere and then launched by executing the "palemoon" file inside it. If for any reason you prefer to manually "install" Pale Moon, you can use the instructions below.</p>
